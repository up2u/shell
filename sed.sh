...
# use NOT .
echo " use NOT ."
echo -e "hello \n word \n to you \n" |  sed -n '/word/!p'   # same as delete the 'word' line
...
#     found, will go through the end line.

echo "will print 2 until 4"
echo -e " line1 \n line2 \n line3 \n line4 \n line5"  | sed -n '/2/,/4/p'

#with multiple match then with string substitution
echo "start substitution from a blank line until has \"line6\" "
...
echo "<b>This</b> is what <b>I</b> meant. " | sed  "s/<.*>//g"       ## will be only meat,for longest match !!??
echo "<b>This</b> is what <b>I</b> meant. " | sed  "s/<[^>]*>//g"    ## [^>] mean NOT >
