...
4: change tabbar & tabbar-ruler, customize-setting.el
 > when update tabbar & tabbar-ruler, need add color.el because it use
   color-name-to-rgb.
 > comment some face attribute setting for not work after update
   tabbar & tabbar-ruler
   (my customize-setting of selected tab background color is yellow
    now is default !)
